...
<section class="hero">
  <h1>Tools</h1>
  <p id="gameCount">Showing all tools</p>
  <input id="searchBar" placeholder="Search tools..." oninput="filterZones()" />
</section>
...
const zones = [
  {
    name: "exthang3r",
    img: "https://github.com/dotdmi/tools/blob/main/exthang3r.png?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/ext.html"
  },
  {
    name: "auk",
    img: "https://github.com/dotdmi/tools/blob/main/auk.png?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/auk.html"
  },
  {
    name: "extprinter",
    img: "https://github.com/dotdmi/tools/blob/main/test.png?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/extp.html"
  },
  {
    name: "sh1mmer",
    img: "https://github.com/dotdmi/tools/blob/main/icon.png?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/sh1mmer.html"
  },
  {
    name: "gdg",
    img: "https://github.com/dotdmi/tools/blob/main/gdg.png?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/gdg.html"
  },
  {
    name: "ruffle",
    img: "https://github.com/dotdmi/tools/blob/main/ruf.png?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/ruffle.html"
  },
  {
    name: "voxiles",
    img: "https://github.com/dotdmi/tools/blob/main/VOX.png?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/vox.html"
  },
  {
    name: "N64",
    img: "https://github.com/dotdmi/tools/blob/main/n64.webp?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/n64.html"
  },
  {
    name: "Tierlist",
    img: "https://github.com/dotdmi/tools/blob/main/icon.png?raw=true",
    fetchHTML: "https://cdn.jsdelivr.net/gh/dotdmi/tools@main/baddies.html"
  },
];

function displayZones(list = zones) {
  container.innerHTML = "";
  count.textContent = `Showing ${list.length} tools`;
